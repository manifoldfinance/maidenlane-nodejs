...
const REPORT_MAPPINGS = {
  [Reports.Types.MATCH]: [
    {
      asset_id_key: "quote_asset_id",
      asset_key: "quote_asset",
      modify_keys: ["cost", "fees"],
    },
    {
      asset_id_key: "base_asset_id",
      asset_key: "base_asset",
      modify_keys: ["quantity"],
    },
  ...
  [Reports.Types.ORDER_RESTING]: [
    {
      asset_id_key: "base_asset_id",
      asset_key: "base_asset",
      modify_keys: ["quantity_removed", "quantity_resting"],
    },
    { is_price: true, market_key: "market", modify_keys: ["price"] },
  ],
  ...
  [Reports.Types.ORDER_DETAILS]: [
    {
      asset_id_key: "base_asset_id",
      asset_key: "base_asset",
      modify_keys: ["quantity", "original_quantity"],
    },
    { is_price: true, market_key: "market", modify_keys: ["price"] },
  ],
  ...
  [Reports.Types.MARKET_STATE_DETAILS]: [
    {
      asset_id_key: "quote_asset_id",
      asset_key: "quote_asset",
      modify_keys: ["fee_limit", "quote_qty", "quote_market_hold", "min_quote_qty"],
    },
    {
      asset_id_key: "base_asset_id",
      asset_key: "base_asset",
      modify_keys: ["base_qty", "base_market_hold", "min_base_qty"],
    },
