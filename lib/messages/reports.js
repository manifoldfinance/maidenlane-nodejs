...
Reports.toJSON = (header) => {
  switch (header.type_id) {
    case Reports.Types.ORDER_RESTING: {
      return new Reports.OrderResting()
        .wrap(header._data_view, header._offset)
        .toJSON();
    }
    case Reports.Types.ORDER_DONE: {
      return new Reports.OrderDone()
        .wrap(header._data_view, header._offset)
        .toJSON();
    }
    case Reports.Types.ORDER_REJECTED: {
      return new Reports.OrderRejected()
        .wrap(header._data_view, header._offset)
        .toJSON();
    }
    case Reports.Types.ORDER_DETAILS: {
      return new Reports.OrderDetails()
        .wrap(header._data_view, header._offset)
        .toJSON();
    }
    case Reports.Types.TRADE_SESSION_OPENED: {
      return new Reports.TradeSessionOpened()
        .wrap(header._data_view, header._offset)
        .toJSON();
    }
    case Reports.Types.MARKET_READY: {
      return new Reports.MarketReady()
        .wrap(header._data_view, header._offset)
        .toJSON();
    }
    case Reports.Types.NEXT_ORDER_TOKEN: {
      return new Reports.NextOrderToken()
        .wrap(header._data_view, header._offset)
        .toJSON();
    }
    case Reports.Types.CURRENT_BALANCE: {
      return new Reports.CurrentBalance()
        .wrap(header._data_view, header._offset)
        .toJSON();
    }
    case Reports.Types.ERROR: {
      return new Reports.Error()
        .wrap(header._data_view, header._offset)
        .toJSON();
    }
    case Reports.Types.ORDER_ACCEPTED: {
      return new Reports.OrderAccepted()
        .wrap(header._data_view, header._offset)
        .toJSON();
    }
    case Reports.Types.ORDER_MODIFIED: {
      return new Reports.OrderModified()
        .wrap(header._data_view, header._offset)
        .toJSON();
    }
    case Reports.Types.SESSION_DETAILS: {
      return new Reports.SessionDetails()
        .wrap(header._data_view, header._offset)
        .toJSON();
    }
    case Reports.Types.MATCH: {
      return new Reports.Match()
        .wrap(header._data_view, header._offset)
        .toJSON();
    }
    case Reports.Types.MARKET_STATE_DETAILS: {
      return new Reports.MarketStateDetails()
        .wrap(header._data_view, header._offset)
        .toJSON();
    }
    case Reports.Types.DEPOSIT_APPLIED: {
      return new Reports.DepositApplied()
        .wrap(header._data_view, header._offset)
        .toJSON();
    }
    case Reports.Types.TRADE_SESSION_CLOSED: {
      return new Reports.TradeSessionClosed()
        .wrap(header._data_view, header._offset)
        .toJSON();
    }
    case Reports.Types.UPDATE_TRADING_LIMIT_RESULT: {
      return new Reports.UpdateTradingLimitResult()
        .wrap(header._data_view, header._offset)
        .toJSON();
    }
    case Reports.Types.PONG: {
      return new Reports.Pong()
        .wrap(header._data_view, header._offset)
        .toJSON();
    }
    case Reports.Types.WITHDRAW_RESULT: {
      return new Reports.WithdrawResult()
        .wrap(header._data_view, header._offset)
        .toJSON();
    }
    default: {
...
Reports.OrderResting_ATTRIBUTES = [
  "header",
  "user_id",
  "quote_asset_id",
  "base_asset_id",
...
class OrderResting {
  ...
  get user_id() {
    const u32_1 = this._data_view.getUint32(
      4 + this._offset + Reports.Header_SIZE,
      true
    );
    const u32_2 = this._data_view.getUint32(
      this._offset + Reports.Header_SIZE,
      true
    );
  ...
  get quote_asset_id() {
    return this._data_view.getUint32(
      this._offset + Reports.Header_SIZE + 8,
      true
    );
  }
  ...
  get base_asset_id() {
    return this._data_view.getUint32(
      this._offset + Reports.Header_SIZE + 12,
      true
    );
  }
  ...
  get order_token() {
    const u32_1 = this._data_view.getUint32(
      4 + this._offset + Reports.Header_SIZE + 16,
      true
    );
    const u32_2 = this._data_view.getUint32(
      this._offset + Reports.Header_SIZE + 16,
      true
    );
    return Big(u32_1).mul("4294967296").add(u32_2) + "";
  }
  ...
  get quantity_removed() {
    const u32_1 = this._data_view.getUint32(
      4 + this._offset + Reports.Header_SIZE + 24,
      true
    );
    const u32_2 = this._data_view.getUint32(
      this._offset + Reports.Header_SIZE + 24,
      true
    );
    return Big(u32_1).mul("4294967296").add(u32_2) + "";
  }
  ...
  get quantity_resting() {
    const u32_1 = this._data_view.getUint32(
      4 + this._offset + Reports.Header_SIZE + 32,
      true
    );
    const u32_2 = this._data_view.getUint32(
      this._offset + Reports.Header_SIZE + 32,
      true
    );
    return Big(u32_1).mul("4294967296").add(u32_2) + "";
  }
  ...
  get price() {
    const u32_1 = this._data_view.getUint32(
      4 + this._offset + Reports.Header_SIZE + 40,
      true
    );
    const u32_2 = this._data_view.getUint32(
      this._offset + Reports.Header_SIZE + 40,
      true
    );
    return Big(u32_1).mul("4294967296").add(u32_2) + "";
  }
  ...
  get is_buy() {
    return (
      this._data_view.getUint8(
        this._offset + Reports.Header_SIZE + 48,
        true
      ) !== 0
    );
  }
  set is_buy(value) {
    this._data_view.setUint8(
      this._offset + Reports.Header_SIZE + 48,
      value ? 1 : 0
    );
  }
...
class OrderDone {
  ...
  get reason() {
    return this._data_view.getUint8(
      this._offset + Reports.Header_SIZE + 41,
      true
    );
  }
  set reason(value) {
...
Reports.OrderRejected_ATTRIBUTES = [
  "header",
  "user_id",
  "order_token",
  "reason",
...
class OrderRejected {
  ...
  get order_token() {
    const u32_1 = this._data_view.getUint32(
      4 + this._offset + Reports.Header_SIZE + 8,
      true
    );
    const u32_2 = this._data_view.getUint32(
      this._offset + Reports.Header_SIZE + 8,
  ...
  get is_buy() {
    return (
      this._data_view.getUint8(
        this._offset + Reports.Header_SIZE + 17,
        true
      ) !== 0
    );
  }
...
Reports.OrderDetails_ATTRIBUTES = [
  "header",
  "user_id",
  "quote_asset_id",
  "base_asset_id",
...
class OrderDetails {
  ...
  get original_quantity() {
    const u32_1 = this._data_view.getUint32(
      4 + this._offset + Reports.Header_SIZE + 48,
      true
    );
    const u32_2 = this._data_view.getUint32(
      this._offset + Reports.Header_SIZE + 48,
  ...
  get is_buy() {
    return (
      this._data_view.getUint8(
        this._offset + Reports.Header_SIZE + 56,
        true
      ) !== 0
    );
  }
...
Reports.MarketReady_ATTRIBUTES = [
  "header",
  "user_id",
  "quote_asset_id",
  "base_asset_id",
...
Reports.NextOrderToken_ATTRIBUTES = [
  "header",
  "user_id",
  "next_order_token",
  "used_tokens",
...
Reports.CurrentBalance_ATTRIBUTES = [
  "header",
  "user_id",
  "asset_id",
  "balance",
...
class CurrentBalance {
  ...
  get balance() {
    const u32_1 = this._data_view.getUint32(
      4 + this._offset + Reports.Header_SIZE + 12,
      true
    );
    const u32_2 = this._data_view.getUint32(
      this._offset + Reports.Header_SIZE + 12,
  ...
  get hold() {
    const u32_1 = this._data_view.getUint32(
      4 + this._offset + Reports.Header_SIZE + 20,
      true
    );
    const u32_2 = this._data_view.getUint32(
      this._offset + Reports.Header_SIZE + 20,
      true
    );
    return Big(u32_1).mul("4294967296").add(u32_2) + "";
  }
...
Reports.OrderAccepted_ATTRIBUTES = [
  "header",
  "user_id",
  "quote_asset_id",
  "base_asset_id",
...
class OrderAccepted {
  ...
  get quantity() {
    const u32_1 = this._data_view.getUint32(
      4 + this._offset + Reports.Header_SIZE + 33,
      true
    );
    const u32_2 = this._data_view.getUint32(
      this._offset + Reports.Header_SIZE + 33,
      true
    );
    return Big(u32_1).mul("4294967296").add(u32_2) + "";
  }
  ...
  get price() {
    const u32_1 = this._data_view.getUint32(
      4 + this._offset + Reports.Header_SIZE + 41,
      true
    );
    const u32_2 = this._data_view.getUint32(
      this._offset + Reports.Header_SIZE + 41,
...
Reports.OrderModified_ATTRIBUTES = [
  "header",
  "user_id",
  "quote_asset_id",
  "base_asset_id",
...
Reports.SessionDetails_ATTRIBUTES = [
  "header",
  "user_id",
  "session_tag",
  "order_count",
...
class Match {
  ...
  get fees() {
    const u32_1 = this._data_view.getUint32(
      4 + this._offset + Reports.Header_SIZE + 56,
      true
    );
    const u32_2 = this._data_view.getUint32(
      this._offset + Reports.Header_SIZE + 56,
  ...
  get limit_version() {
    const u32_1 = this._data_view.getUint32(
      4 + this._offset + Reports.Header_SIZE + 64,
      true
    );
    const u32_2 = this._data_view.getUint32(
      this._offset + Reports.Header_SIZE + 64,
      true
    );
    return Big(u32_1).mul("4294967296").add(u32_2) + "";
  }
  ...
  get is_maker() {
    return (
      this._data_view.getUint8(
        this._offset + Reports.Header_SIZE + 72,
        true
      ) !== 0
    );
  }
  ...
  get is_buy() {
    return (
      this._data_view.getUint8(
        this._offset + Reports.Header_SIZE + 73,
        true
      ) !== 0
    );
  }
...
Reports.MarketStateDetails_ATTRIBUTES = [
  "header",
  "user_id",
  "quote_asset_id",
  "base_asset_id",
  ...
  "quote_shift_qty_minor",
  "base_shift_qty_major",
  "base_shift_qty_minor",
];
class MarketStateDetails {
  ...
  get quote_qty() {
    ...
    return (
      (r.gt("9223372036854775807") ? r.sub("18446744073709551616") : r) + ""
    );
  }
  get base_qty() {
    const u32_1 = this._data_view.getUint32(
  ...
  get min_base_qty() {
    const u32_1 = this._data_view.getUint32(
      4 + this._offset + Reports.Header_SIZE + 72,
      true
    );
    const u32_2 = this._data_view.getUint32(
      this._offset + Reports.Header_SIZE + 72,
  ...
  get long_max_price() {
    const u32_1 = this._data_view.getUint32(
      4 + this._offset + Reports.Header_SIZE + 80,
      true
    );
    const u32_2 = this._data_view.getUint32(
      this._offset + Reports.Header_SIZE + 80,
      true
    );
    return Big(u32_1).mul("4294967296").add(u32_2) + "";
  }
  ...
  get short_min_price() {
    const u32_1 = this._data_view.getUint32(
      4 + this._offset + Reports.Header_SIZE + 88,
      true
    );
    const u32_2 = this._data_view.getUint32(
      this._offset + Reports.Header_SIZE + 88,
      true
    );
    return Big(u32_1).mul("4294967296").add(u32_2) + "";
  }
  ...
  get quote_shift_qty_major() {
    return this._data_view.getInt32(
      this._offset + Reports.Header_SIZE + 96,
      true
    );
  }
  set quote_shift_qty_major(value) {
    this._data_view.setInt32(
      this._offset + Reports.Header_SIZE + 96,
      +value,
      true
    );
  ...
  get quote_shift_qty_minor() {
    const u32_1 = this._data_view.getUint32(
      4 + this._offset + Reports.Header_SIZE + 100,
      true
    );
    const u32_2 = this._data_view.getUint32(
      this._offset + Reports.Header_SIZE + 100,
      true
    );
    return Big(u32_1).mul("4294967296").add(u32_2) + "";
  }
  ...
  get base_shift_qty_major() {
    return this._data_view.getInt32(
      this._offset + Reports.Header_SIZE + 108,
      true
    );
  }
  ...
  get base_shift_qty_minor() {
    const u32_1 = this._data_view.getUint32(
      4 + this._offset + Reports.Header_SIZE + 112,
      true
    );
    const u32_2 = this._data_view.getUint32(
      this._offset + Reports.Header_SIZE + 112,
      true
    );
    return Big(u32_1).mul("4294967296").add(u32_2) + "";
  }
...
Reports.DepositApplied_ATTRIBUTES = [
  "header",
  "user_id",
  "asset_id",
  "current_balance",
...
Reports.UpdateTradingLimitResult_ATTRIBUTES = [
  "header",
  "user_id",
  "quote_asset_id",
  "base_asset_id",
...
Reports.WithdrawResult_ATTRIBUTES = [
  "header",
  "user_id",
  "asset_id",
  "quantity",
