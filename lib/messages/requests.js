...
class Ping {
  ...
  get request_id() {
    const u32_1 = this._data_view.getUint32(
      4 + this._offset + Requests.Header_SIZE,
      true
    );
    const u32_2 = this._data_view.getUint32(
      this._offset + Requests.Header_SIZE,
      true
    );
    return Big(u32_1).mul("4294967296").add(u32_2) + "";
  }
...
Requests.PrepareMarket_ATTRIBUTES = [
  "header",
  "user_id",
  "quote_asset_id",
  "base_asset_id",
...
class PrepareMarket {
  ...
  get quote_asset_id() {
    return this._data_view.getUint32(
      this._offset + Requests.Header_SIZE + 8,
      true
    );
  }
  ...
  get base_asset_id() {
    return this._data_view.getUint32(
      this._offset + Requests.Header_SIZE + 12,
      true
    );
  }
...
class ListOpenOrders {
  ...
  get after_order_token() {
    const u32_1 = this._data_view.getUint32(
      4 + this._offset + Requests.Header_SIZE + 8,
      true
    );
    const u32_2 = this._data_view.getUint32(
      this._offset + Requests.Header_SIZE + 8,
...
class OpenTradeSession {
  ...
  set access_key(value) {
    ...
    for (let i = 0; i < 32; ++i) {
      const b =
        parseInt(value[i * 2], 16) * 16 + parseInt(value[i * 2 + 1], 16);
...
class NewOrder {
  ...
  get order_token() {
    const u32_1 = this._data_view.getUint32(
      4 + this._offset + Requests.Header_SIZE + 16,
      true
    );
    const u32_2 = this._data_view.getUint32(
      this._offset + Requests.Header_SIZE + 16,
      true
    );
    return Big(u32_1).mul("4294967296").add(u32_2) + "";
  }
  ...
  get replace_order_token() {
    const u32_1 = this._data_view.getUint32(
      4 + this._offset + Requests.Header_SIZE + 24,
      true
    );
    const u32_2 = this._data_view.getUint32(
      this._offset + Requests.Header_SIZE + 24,
      true
    );
    return Big(u32_1).mul("4294967296").add(u32_2) + "";
  }
  ...
  get quantity() {
    const u32_1 = this._data_view.getUint32(
      4 + this._offset + Requests.Header_SIZE + 32,
      true
    );
    const u32_2 = this._data_view.getUint32(
      this._offset + Requests.Header_SIZE + 32,
      true
    );
    return Big(u32_1).mul("4294967296").add(u32_2) + "";
  }
  ...
  get price() {
    const u32_1 = this._data_view.getUint32(
      4 + this._offset + Requests.Header_SIZE + 40,
      true
    );
    const u32_2 = this._data_view.getUint32(
      this._offset + Requests.Header_SIZE + 40,
      true
    );
    return Big(u32_1).mul("4294967296").add(u32_2) + "";
  }
  ...
  get is_buy() {
    return (
      this._data_view.getUint8(
        this._offset + Requests.Header_SIZE + 48,
        true
      ) !== 0
    );
  }
...
Requests.CancelOrder_ATTRIBUTES = [
  "header",
  "user_id",
  "order_token",
  "leaves_quantity",
